# Środowisko: Windows 11
# Przeglądarka Mozilla Firefox 100.4

*** Settings ***
Documentation     Automated Tests for adding products and register in coffee shop
...
${LOGO}    //a[@class='header-logo-main-link']
...
First Test - Adding Product To Shopping Cart
    ...
    Go to Product's View And Choose Amount
